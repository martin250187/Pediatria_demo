...
if ($conn->connect_error) {
  die("Connection failed: " . $conn->connect_error);
            ...
            $query = "SELECT pacientes.id_paciente, pacientes.apellido, pacientes.nombre, pacientes.edad, pacientes.uni_edad, pacientes.telefono, turnos.id_paciente, turnos.fecha_turno,turnos.hora_turno from pacientes JOIN turnos ON pacientes.id_paciente=turnos.id_paciente WHERE turnos.fecha_turno >= '$hoy' ORDER BY turnos.fecha_turno";
        ...
        <div class="container-fluid">
          ...
          <tbody>
            <tr>
              ...
              <td><?php echo $mostrar['edad'];echo " ";echo $mostrar['uni_edad']?></td>
              <td><?php echo $mostrar['telefono']?></td>
              <td><?php echo $mostrar['fecha_turno']?></td>
              <td><?php echo $mostrar['hora_turno']?></td>
            </tr>
          </tbody>
