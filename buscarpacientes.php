...
$busqueda = '';
          ...
          if (!empty($_REQUEST['search'])){
              ...
              $where = "apellido LIKE '%$busqueda%' OR nombre LIKE '%$busqueda%' OR edad LIKE '%$busqueda%' OR telefono LIKE '%$busqueda%' OR grupo_sanguineo LIKE '%$busqueda%'";
          }
            
            $query = "SELECT * from pacientes WHERE $where";
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="min-height: 80px;">
        <div class="container-fluid">
          ...
          <form class="d-flex" role="search" style="margin-top: 10px;">
            ...
            <button class="btn btn-outline-secondary" type="submit" title="Buscar" onclick="" id="searchBtn"><i class="fa fa-search" aria-hidden="true"></i></button>  
          </form>
          </div>
          </nav>
          ...
          <tbody>
            <tr id="lista">
              ...
              <td style="color:red"><?php echo $mostrar['edad']?></td>
              <td style="color:red"><?php echo $mostrar['telefono']?></td>
              <td style="color:red"><?php echo $mostrar['grupo_sanguineo']?></td>
              <td>
                  <div class="container-fluid">
